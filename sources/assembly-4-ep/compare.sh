...
# curl https://raw.githubusercontent.com/everypolitician/everypolitician-data/master/data/Angola/National_Assembly/term-4.csv | qsv select wikidata,name,wikidata_group,group,wikidata_area,area,start_date,end_date,gender | sed -e 's/Q1740056/Q1425821/g' | qsv rename item,name,party,partyLabel,area,areaLabel,startDate,endDate,gender > scraped.csv
